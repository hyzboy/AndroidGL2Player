 ...
 */
class GL2PlayerView extends GLSurfaceView {
    private static String TAG = "GL2PlayerView";
    private static final boolean DEBUG = false;

    public GL2PlayerView(Context context) {
        super(context);
        init(false, 0, 0);
    }

    public GL2PlayerView(Context context, boolean translucent, int depth, int stencil) {
        super(context);
